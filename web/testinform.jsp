...
-->
    ...
    <table width="968" border="0" align="center" bgcolor="#FFFFFF">
      <tr>
        <td width="962"><table width="960" border="0">
          <tr>
...
sdf = new SimpleDateFormat("yyyy-M-dd hh:mm:ss");
 ...
 f12=sdf1.format(date);
   int vv=0,vv1=0,flag=0,f=0;
                                ...
                                String st1="",st2="";
                              ResultSet rs1 = st.executeQuery("select * from dtest where uid='"+a11+"'");
		if(rs1!=null)
			{ 
                            f=1;
                        }
                if(f==1){
		ResultSet rs = st.executeQuery("select * from dtest where uid='"+a11+"'");
		if(rs!=null)
			{ 
   ...
   <tr>
      <td width="59" height="33" ><div align="center" class="style21 style3 style19 style14"><strong>TId</strong></div></td>
      <td width="96"><div align="center" class="style21 style3 style19 style14"><strong>User Id </strong></div></td>
      <td width="134"><div align="center" class="style21 style3 style19 style14"><strong> Name </strong></div></td>
	  <td width="92"><div align="center" class="style21 style3 style19 style14"><strong>Reason</strong></div></td>
      <td width="107"><div align="center" class="style21 style3 style19 style14"><strong>Subdate</strong></div></td>
	    <td width="144"><div align="center" class="style21 style3 style19 style14"><strong>Test detail</strong></div></td>
		<td width="144"><div align="center" class="style21 style3 style19 style14"><strong>Status</strong></div></td>
		<td width="144"><div align="center" class="style21 style3 style19 style14"><strong>Lab Description</strong></div></td>
    </tr>
    ...
    <tr>
      ...
      <td width="102"><div align="center"><%=rs.getString(11)%></div></td>
	         <td width="150"><div align="center"><%=rs.getString(12)%></div></td>
   <%  }
...
int sts=0;
  ...
  sts=smt9.executeUpdate("insert into searchblock values('"+firstBlock.hashCode()+"','"+transaction1+"','" + r3 + "','" + r4 + "','" + r5 + "','" + a11 + "','"+st2+"','"+f11+"','"+f12+"','Test information')");
                  } else{
                                        									%>
  Crossed the Limit..!
    <%
