    ...
    if((a1.equals(""))||(a2.equals(""))||(a3.equals(""))||(a4.equals("")))
              {
                   request.setAttribute("ok", "1");
                    request.setAttribute("msg", "Please press enter");
                      RequestDispatcher rs=request.getRequestDispatcher("ambulance.jsp");
                     rs.forward(request, response); 
              }else{

                  
                    int val = st.executeUpdate("insert into ambulance values('" + a1 + "','" + a2 + "','" + a3 + "','" + a4 + "')");
                    ...
                    if (val == 1) {
                        ...
                        RequestDispatcher requestdispatcher = request.getRequestDispatcher("ambulance.jsp");
