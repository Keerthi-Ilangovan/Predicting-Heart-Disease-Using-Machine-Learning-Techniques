...
sdf = new SimpleDateFormat("MMMM");
 a11=sdf.format(date);
     ...
     System.out.println(i2);
                 ResultSet rs2 = smt2
			.executeQuery("select max(lid) from etest ");
				if (rs2.next()) {
...
sdf = new SimpleDateFormat("yyyy-M-dd hh:mm:ss");
 f11=sdf.format(date);
                ...
                int v = smt.executeUpdate("insert into etest values('" +r2 + "','" + a1 + "','" + r3 + "','" + r4 + "','" + a2 + "','" + a3 + "','"+ a4 +"','"+ a5 +"','"+ a6 +"','"+ a7+"')");
                 System.out.println("insert into etest values('" +r2 + "','" + a1 + "','" + r3 + "','" + r4 + "','" + a2 + "','" + a3 + "','"+ a4 +"','"+ a5 +"','"+ a6 +"','"+ a7 +"')");
                if ((v == 1)) {
                    request.setAttribute("ok", "1");
                
                    request.setAttribute("msg", "Successfully stored");
                    RequestDispatcher rs = request.getRequestDispatcher("denter.jsp");
...
sdf = new SimpleDateFormat("yyyy-M-dd hh:mm:ss");
 ...
 f12=sdf1.format(date);
  ...
  Transaction transaction2 = new Transaction(s2, a1, 150L);
...
int sts=0;
   ...
   sts=smt9.executeUpdate("insert into searchblock values('"+firstBlock.hashCode()+"','"+transaction1+"','" + r3 + "','" + r4 + "','" + r5 + "','" + s1 + "','"+s3+"','"+f11+"','"+f12+"','Diagnosis Enter information')");	
              ...
              System.out.println(s3);
                ...
                RequestDispatcher requestdispatcher = request.getRequestDispatcher("denter.jsp");
