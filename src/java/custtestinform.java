 ...
 * @author perumal s
 */
public class custtestinform extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try
		{
			...
			ResultSet rs=st.executeQuery("select * from testprescribed where pid='"+so.getAttribute("un") +"' ");
			...
			requestdispatcher.forward(request, response);}else{
                          request.setAttribute("ss", "1");
                    	request.setAttribute("al", "Not available");
			RequestDispatcher requestdispatcher = request.getRequestDispatcher("custinform.jsp");
