 ...
 * @author Perumal S
 */
public class labassistance extends HttpServlet {
...
String s7 = null;   
		ArrayList al=new ArrayList();
                  ...
                  if((a1.equals(""))||(a2.equals(""))||(a3.equals(""))||(a4.equals(""))||(a5.equals(""))&&(a6.equals(""))||(a7.equals("")))
              {
                   request.setAttribute("ok", "1");
                    request.setAttribute("msg", "Please press enter");
                      RequestDispatcher rs=request.getRequestDispatcher("lregister.jsp");
	      ...
	      int v=smt.executeUpdate("insert into doctor values('"+a1+"','"+a2+"','"+a3+"','"+a4+"','"+a5+"','"+a6+"','"+a7+"','"+a1+"','"+a2+"','"+a8+"')");
			...
			RequestDispatcher requestdispatcher = request.getRequestDispatcher("lregister.jsp");
